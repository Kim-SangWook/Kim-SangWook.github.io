...
friedman_data = function(n, num_cov, sd_error){
  ...
  # Equation proposed by Friedman
  return(list(y = y,
              x = x))
}
```

n : 샘플 사이즈 ( paper에서 200, 500, 1000)

num\_cov : 공변량 갯수 ( paper에서 5, 10, 50개)

sd\_error: 에러의 표준편차 (paper에서 1로 줌)
